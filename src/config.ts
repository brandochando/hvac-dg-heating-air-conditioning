...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "DG Heating";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "DG Heating & Air Conditioning";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "DG Heating & Air Conditioning";          // e.g. "AirPro Heating & Air Conditioning, Inc."
export const BRAND_TAGLINE    = "Professional HVAC Service & Repair in San Jose";        // e.g. "Fast, Honest HVAC in San Jose"
export const BRAND_LICENSE    = "License #1035345 · C-20";  // e.g. "License #1069959"
export const BRAND_INITIALS   = "DHA";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 669-3496";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14086693496";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "admin@dgheatingandair.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "1040 Commercial St #104 San Jose CA 95112";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"
...
export const PRIMARY_COLOR   = "#0000EE";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "DG Heating & Air Conditioning — San Jose HVAC";
export const SEO_DESCRIPTION = "DG Heating & Air Conditioning — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 669-3496";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "DG Heating & Air Conditioning technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The DG Heating Promise",
...
export const TESTIMONIALS = [
  {
    quote: "Amazing service after 7pm! I called and spoke with John. We are a repeat customer.",
    author: "Mike W.",
    role: "Google Review · 5★",
  },
  {
    quote: "Antonio came to service my heat pump system this morning. I am always pleased with the service I receive from DG.",
    author: "David K.",
    role: "Google Review · 5★",
  },
  {
    quote: "Joey was fantastic. He was very professional and on point. Overall, a great experience.",
    author: "Satish A.",
    role: "Google Review · 5★",
  },
  {
    quote: "Brandon and Joe came to troubleshoot our AC system quickly and fixed it immediately.",
    author: "Sal B.",
    role: "Google Review · 5★",
  }
];
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — DG Heating & Air Conditioning has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. DG Heating & Air Conditioning is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
  ...
  },
  {
    ...
    a: "We provide Residential HVAC, New Construction HVAC, Light Commercial HVAC, Air Conditioning, Heating Services, Duct Removal & Replacement — for both residential and commercial properties. Installations, replacements, repairs, and…",
  },
  {
